...
// use ldtk_rust::{TilesetDefinition, TileInstance, Project};
...
// }
// impl MapTile {
//     pub fn from_ldtk_tile(tile: &TileInstance, y_flip: i64, grid_size: i64, center_offset: IVec2 ) -> Self {
...
//     tileset_name_map: HashMap<String, i32>,
//     pub tile_size: IVec2,
// }
...
// fn build_map(p: &Project, atlases: &mut ResMut<Assets<TextureAtlas>>) -> Option<LdtkMap> {
...
//             map.tileset_name_map.insert(def.identifier.clone(), def.uid as i32);
//         }
...
//                 let y_flip = pixel_height - grid_size;
//                 let center_offset = map.size / 2;

//                 for tile in layer.grid_tiles.iter() {
//                     let tile = MapTile::from_ldtk_tile(tile, y_flip, grid_size, center_offset);
